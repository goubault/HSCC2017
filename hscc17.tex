...
using optimized solvers such as VNode. Among the examples studied in ~\cite{Underapproxflowpipes,underapprox16}, we selected
...
of the set of vectors (not mentioned). 
...
They study the result for T = 3 and T = 4. We choose, as they do, 4th order Taylor models. 
\begin{center}
...
In \cite{underapprox16} they take X=[0.3, 0.4] × [0.5, 0.7] for a time frame in [0,1.1], and a time step h=0.05. 
