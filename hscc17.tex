...
SpaceEx \cite{SPACEEX}, Flow* \cite{FLOW}, \cite{Althoff2} and VNODE-LP \cite{VNODELP} to mention but a few. 

CHECK \cite{kaynama2012computing,DBLP:phd/hal/LeGuernic09,Cardaliaguet2007}.
...
%******************************************************************************
%----------------------------------------------------------------------------------------------------------------------------------------------------------------
We implemented \footnote{available from \url{http://www.lix.polytechnique.fr/Labo/Sylvie.Putot/software.html}}{} our method as follows: we use the {\tt FILIB++} C++ library~\cite{filib} for 
