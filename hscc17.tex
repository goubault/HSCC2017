...
We thus measure in our case \[ \gamma_{\min}=\min_{i}{\frac{\gamma_u(x_i)}{\gamma_u(x_i)}}, \]
...
We fist consider again the Brusselator model
, with the initial set taken in~\cite{Underapproxflowpipes}, defined by 
