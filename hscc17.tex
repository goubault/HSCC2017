...
We fist consider again the Brusselator model, with the initial set taken in~\cite{Underapproxflowpipes}, defined by 
...
In \cite{underapprox16} they take [0.3, 0.4] × [0.5, 0.7] for T = 1.1 seconds. 

% condition initiale
X = [infsup(0.3,0.4) ; infsup(0.5,0.7)]

% pas
tau = 0.05
tmax = 1.1
time (order 4 Taylor Model, AA) =  118.1229
