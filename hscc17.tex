...
the component that makes $\gamma$ decrease drastically around $t=4$. We see that whenever the width of the inner-approximation on $x_2$ decreases 
...
difficult case for demonstrating the good behavior of the inner-approximation, as its width tends towards 0 as we note on 
Figure~\ref{ex:width_sriram_bruss2}.
