...
Taylor models and a timestep of 0.1, we now get a computation time of 93 seconds, thus comparable now to \cite{Underapproxflowpipes}. 
...
\paragraph{Comparison on the Brusselator}
In \cite{underapprox16} they consider the Brusselator system for an initial value $X=[0.3, 0.4] \times [0.5, 0.7]$, a time frame in [0,1.1], and a time step h=0.05. 
...
\ForAuthors{Sylvie. Continuer - pas de garnatie sur leur em etc}
