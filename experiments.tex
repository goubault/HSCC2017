...
while with teh results of \cite{underapprox16} we get the lower quality results
...
our outer-approximation, our inner-approximation, and that of \cite{underapprox16} (which is sometimes 0, explaining absent 'related' bars for some variables).
\begin{figure}[htbp]
\begin{center}
