...
\ForAuthors{reflechir a ce qu'on peut en deduire sur le systeme (cycle?), et si on veut que je fasse d'autres experiences ? Bof, non pas evident, en plus la surapprox ou combinaison avant arriere
suffit en general, plus tard on verra (c'est l'article Verifyin Analog Oscillator Circuits)}
